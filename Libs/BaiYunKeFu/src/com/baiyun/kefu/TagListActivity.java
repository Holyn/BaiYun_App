...
public class TagListActivity extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		int id = v.getId();
		if (id == R.id.profile_reback_btn) {
			finish();
		}else if (id == R.id.layout_personal_nickname) {
			change_nickname();
		}else if (id == R.id.layout_personal_sex) {
			change_sex();
		}else if (id == R.id.layout_personal_language) {
			change_language();
		}else if (id == R.id.layout_personal_city) {
			change_city();
		}else if (id == R.id.layout_personal_province) {
			change_province();
		}else if (id == R.id.layout_personal_country) {
			change_country();
		}else if (id == R.id.layout_other_country) {
			change_other();
		}
	}

...
public class HomeCooNewsPar implements Parcelable {
	private String id;
	...
	public static final Parcelable.Creator<HomeCooNewsPar> CREATOR = new Parcelable.Creator<HomeCooNewsPar>() {
		public HomeCooNewsPar createFromParcel(Parcel in) {
			HomeCooNewsPar par = new HomeCooNewsPar();
		...
		public HomeCooNewsPar[] newArray(int size) {
			return new HomeCooNewsPar[size];
		}
	};

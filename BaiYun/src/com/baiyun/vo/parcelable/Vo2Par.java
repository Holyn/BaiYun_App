...
public class Vo2Par implements Parcelable {
	private String id;
	...
	public static final Parcelable.Creator<Vo2Par> CREATOR = new Parcelable.Creator<Vo2Par>() {
		public Vo2Par createFromParcel(Parcel in) {
			Vo2Par par = new Vo2Par();
		...
		public Vo2Par[] newArray(int size) {
			return new Vo2Par[size];
		}
	};

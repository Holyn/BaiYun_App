...
public class LNewsPar implements Parcelable {
	private String id;
	...
	public static final Parcelable.Creator<LNewsPar> CREATOR = new Parcelable.Creator<LNewsPar>() {
		public LNewsPar createFromParcel(Parcel in) {
			LNewsPar par = new LNewsPar();
		...
		public LNewsPar[] newArray(int size) {
			return new LNewsPar[size];
		}
	};

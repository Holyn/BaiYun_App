...
public class HomeVideoPar implements Parcelable {
	private String id;
	...
	public static final Parcelable.Creator<HomeVideoPar> CREATOR = new Parcelable.Creator<HomeVideoPar>() {
		public HomeVideoPar createFromParcel(Parcel in) {
			HomeVideoPar par = new HomeVideoPar();
		...
		public HomeVideoPar[] newArray(int size) {
			return new HomeVideoPar[size];
		}
	};

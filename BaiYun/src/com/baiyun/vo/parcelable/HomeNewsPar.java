...
public class HomeNewsPar implements Parcelable {
	private String id;
	...
	public static final Parcelable.Creator<HomeNewsPar> CREATOR = new Parcelable.Creator<HomeNewsPar>() {
		public HomeNewsPar createFromParcel(Parcel in) {
			HomeNewsPar par = new HomeNewsPar();
		...
		public HomeNewsPar[] newArray(int size) {
			return new HomeNewsPar[size];
		}
	};

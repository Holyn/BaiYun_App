...
public class OveDepTeacherPar implements Parcelable {
	private String id;
	...
	public static final Parcelable.Creator<OveDepTeacherPar> CREATOR = new Parcelable.Creator<OveDepTeacherPar>() {
		public OveDepTeacherPar createFromParcel(Parcel in) {
			OveDepTeacherPar par = new OveDepTeacherPar();
		...
		public OveDepTeacherPar[] newArray(int size) {
			return new OveDepTeacherPar[size];
		}
	};

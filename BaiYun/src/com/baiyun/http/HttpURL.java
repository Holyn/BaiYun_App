...
public class HttpURL {
	...
	/* 服务器地址 */
	public final static String HOST = HTTP+"119.145.135.181/GZBYSystem";
	...
	/**
	 * 招生服务-网上报名-专业选择
	 * http://119.145.135.181/GZBYSystem/app/applyCourse?type=32
	 */
	 ...
	 * http://119.145.135.181/GZBYSystem/app/onlineRegisterForm?id=
	 */
	public final static String APPLY_FORM_1 = URL_PRE + "onlineRegisterForm";
	
	/**
	 * 招生服务-网上报名-导入报名表2接口：导入（职业技能培训招生）报名表至后台 
	 * http://119.145.135.181/GZBYSystem/app/trainingRegisterForm?id=
	 */
	 ...
	 * http://119.145.135.181/GZBYSystem/app/schoolLifeDetails?type=24&id=26&limit=10&page=1
	 */
	 ...
	 * http://119.145.135.181/GZBYSystem/app/schoolLifeDetails?type=25
	 */
	public final static String LIFE_ASSOCIATION = URL_PRE + "schoolLifeDetails?type=25";
	
	/**
	 * 校园生活--学生社团--社团动态新闻
	 * 访问地址：http://119.145.135.181/GZBYSystem/app/associationNews?
	...
	/**
	 * 校园生活--榜样白云(List)
	 * http://119.145.135.181/GZBYSystem/app/schoolLifeDetails?type=26&limit=10&page=1
	 */
	public final static String LIFE_MODEL = URL_PRE + "schoolLifeDetails?type=26&limit=10&page=";
	
	/**
	 * 校园生活--服务指南
	 * http://119.145.135.181/GZBYSystem/app/schoolLifeDetails?type=27
	 */
	public final static String LIFE_GUIDE = URL_PRE + "schoolLifeDetails?type=27";
	
	/**
	 * 校内服务--通知公告
	 * http://119.145.135.181/GZBYSystem/app/serviceType?type=31&limit=10&page=1
	 */
	...
	/**
	 * 校内服务--故障报修
	 * http://119.145.135.181/GZBYSystem/app/serviceType?type=42
	 */
	 ...
	 * 
	 * http://119.145.135.181/GZBYSystem/app/userLogin?
	...
	/**
	 * 右侧菜单--使用工具--班车表
	 * http://119.145.135.181/GZBYSystem/app/utilityToolDetails?id=168
	 */
	public final static String R_TOOLS_BUS = URL_PRE + "utilityToolDetails?id=168";
	
	/**
	 * 右侧菜单--使用工具--地铁路线图
	 * http://119.145.135.181/GZBYSystem/app/utilityToolDetails?id=169
	 */
	public final static String R_TOOLS_METRO = URL_PRE + "utilityToolDetails?id=169";
	/**
	 * 右侧菜单--使用帮助
	 * http://119.145.135.181/GZBYSystem/app/settingDetails?id=129
	 */
	public final static String R_HELP = URL_PRE + "settingDetails?id=129";
	
	/**
	 * 右侧菜单--关于我们
	 * http://119.145.135.181/GZBYSystem/app/settingDetails?id=171
	 */
	public final static String R_ABOUT = URL_PRE + "settingDetails?id=171";
	
	/**
	 * 右侧菜单--版本更新
	 * http://119.145.135.181/GZBYSystem/app/settingDetails?id=128&version=1
	 */
